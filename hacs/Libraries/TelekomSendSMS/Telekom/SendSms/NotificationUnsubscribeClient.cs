...
namespace Telekom.SendSms
{
    ...
    /// </summary>
    public class NotificationUnsubscribeClient : TelekomClient
    {
        /// <summary>
        ...
        public NotificationUnsubscribeClient(TelekomAuth authentication, ServiceEnvironment serviceEnvironment)
