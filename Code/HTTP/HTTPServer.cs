...
namespace HTTP
{
    ...
    public class HttpServer
    {
        ...
        #region Construction
        public HttpServer(Int32 HTTP_Port, String HTTP_ListeningIP, String HTTP_DocumentRoot)
        {
        ...
        public void listen()
        {
            ...
            try
            {
                ...
                listener.Listen(-1);
                ConsoleOutputLogger.WriteLine("[HTTP] Administrationsoberfläche unter http://" + HTTPServer_ListeningIP+ ":" + HTTPServer_Port+ " erreichbar.");
                while (true)
                {
                    try
                    {
                        ...
                        HttpProcessor processor = new HttpProcessor(s, HTTPServer_DocumentRoot);
