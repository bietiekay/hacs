...
namespace hacs
{
	class MainClass
	{
		...
		{
			Console.WriteLine("hacs miataru database tool - part of the h.a.c.s toolkit");
			Console.WriteLine("(C) 2014 Daniel Kirstenpfad - http://technology-ninja.com");
			Console.WriteLine();

			Console.WriteLine("This tool exports a certain miataru account from the miataru hacs database.");
			Console.WriteLine();
			Console.WriteLine("Usage:");
			Console.WriteLine();
			Console.WriteLine("miataru-export <option> <db-filename>\t");
			Console.WriteLine();
			Console.WriteLine ("Options:");
			Console.WriteLine("\t-sl\tthis parameter lists all available accounts");
			Console.WriteLine("\t-kml\tthis parameter exports all available location data for a certain accountname as kml");
			Console.WriteLine();
		}
		#endregion
